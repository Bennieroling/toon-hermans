...
/**
 * The first hero shipped on the homepage — kept here for the /demo/heroes
 * page so we can always come back to it for comparison or to share with
 * outside reviewers. Renders the real architectural-blueprint raster image
 * with the original single WiFi-pulse overlay.
 */
export function HeroOriginal() {
  ...
  return (
    <section className="relative flex min-h-screen flex-col overflow-hidden pt-24 md:flex-row">
