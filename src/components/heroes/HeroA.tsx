...
/**
 * Path A — V5-style schematic floor plan as the hero visual.
 * Reuses the V5Topology SVG in "bare" mode so the hero and the
 * 8-layer experience share one visual language.
 */
      ...
      <div className="relative h-[50vh] w-full shrink-0 overflow-hidden md:h-auto md:w-1/2">
        <div className="absolute inset-0 flex items-center justify-center px-6 py-10 sm:px-10">
          <div className="w-full max-w-2xl">
            <V5Topology bareFloorPlan disableInteractions />
          </div>
        </div>
